...
const printCards = (data) => {
  data.forEach((product) => {
    templateCard.querySelector(".template-card__title").textContent =
      product.title;
    templateCard.querySelector(".template-card__price").textContent =
      product.precio;
    templateCard
      .querySelector(".template-card__img")
      .setAttribute("src", product.thumbnailUrl);
    templateCard.querySelector(".template-card__btn-buy").dataset.id =
      product.id;
...
const printCarrito = () => {
  ...
  Object.values(carrito).forEach((product) => {
    templateCarrito.querySelector(".template-carrito__id").textContent =
      product.id;
    templateCarrito.querySelector(".template-carrito__title").textContent =
      product.title;
    templateCarrito.querySelector(".template-carrito__units").textContent =
      product.units;
    templateCarrito.querySelector(".template-carrito__price").textContent =
      product.price;
    templateCarrito.querySelector(".template-carrito__multiply").textContent =
      product.units * product.price;
    templateCarrito.querySelector(".template-carrito__btn-add").dataset.id =
      product.id;
    templateCarrito.querySelector(
      ".template-carrito__btn-subtract"
...
const printFooter = () => {
  ...
  templateFooter.querySelector(".template-footer__total-units").textContent =
    nUnits;
  templateFooter.querySelector(".template-footer__total-price").textContent =
    nPrice;
